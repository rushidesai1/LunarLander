...
# start at 0.0 and increment 0.02 until we hit 1
lambdas = np.arange(0.0, 1.02, 0.02)
...
rmse_file_name = "RMSE_best_rmse_error_seed_30.pkl"
if use_local:
...
RMSE_plot = RMSE_vector.min(axis=1)

# Plot RMSE vs lambda
plt.plot(lambdas, RMSE_plot)
# Format and show the plot
plt.ylabel('RMSE using best α')
plt.xlabel('λ')
plt.title('Replication of Figure 5 in Sutton (1988)')
